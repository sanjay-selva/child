...
export default function Childmainpage(){
  ...
  <div className="carousel-inner">
   ...
   <h6 >This platform is strictly intended for child-related welfare purposes and any misuse is prohibited.</h6>
       
         <a href="Orphanage" className=" m-3 btn btn-outline-warning fw-bold">Orphanage Detail</a>
    ...
    <div className="carousel-item "  data-bs-interval="2000">
      ...
      <div className="carousel-caption  my-0">
        ...
        <p>A child orphanage is a place that provides care, shelter, education, and emotional support to children who have lost their parents or do not have family support. It ensures a safe environment where children can grow, learn good values, and build a better future. Orphanages also focus on the overall development of children by providing healthcare, education, and love.</p>
           <h6>This platform is strictly intended for child-related welfare purposes and any misuse is prohibited.</h6>
         <div className="">
        <h2> <a href="Orphanage" className="btn btn-outline-warning fw-bold">Orphanage Detail</a></h2>
        </div>
  ...
  <button className="btn button  " type="button" >Button</button>
            ...
            <div className="about-title mt-5">
                ...
                <div className="col-lg-3 ">
                   ...
                   <ol>
                   <p className="text-center text-secondary">We care for children by offering food, shelter, education, and emotional support,  grow into responsible and confident individuals.</p>
